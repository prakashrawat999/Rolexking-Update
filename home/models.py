...
class Rolex_Number(models.Model):
    ...
    Today_Number = models.CharField(max_length=20)
    Sign = models.CharField(max_length=7, choices=Warning_CHOICES)
    Description = models.TextField(max_length=50)
    Created_at = models.DateTimeField(editable=False)
    Upload_to = models.DateTimeField(editable=False)
    Month = models.CharField(max_length=3, choices=MONTH_CHOICES, blank=True, editable=False)
    Year = models.CharField(max_length=4, choices=YEAR_CHOICES, blank=True, editable=False)
    Week = models.CharField(max_length=3, choices=WEEK_CHOICES, blank=True, editable=False)
